...
module.exports = {
    ...
    execute: async (client, interaction) => {
        ...
        if (interaction.user.id === TicketSchema.creatorId) {
            await TicketTool.closeTicket(interaction, TicketSchema, 'General Support Ticket', 'Closed By Owner');
        } else {
            await TicketTool.closeTicket(interaction, TicketSchema, 'General Support Ticket', 'Closed By Staff');
        };
    },
};