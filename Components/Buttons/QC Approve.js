...
module.exports = {
    ...
    execute: async (client, interaction) => {
        ...
        QCEmbed.data.color = 0x2ecc71;
        QCEmbed.data.footer = { text: `Approved by: @${interaction.user.username}`, icon_url: ReviewerIcon };
        ...
        await interaction.reply({ content: `Successfully marked as approved!`, flags: ['Ephemeral'] });
    },
};